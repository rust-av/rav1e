...
pub static av1_default_coeff_base_multi_cdfs: [[[u16; NUM_BASE_LEVELS + 2];
  ...
  [
    ...
    // Contexts 26..=40 omitted
    // qctx = 0, txs_ctx = 32x32, plane = 1
    cdf!(2461, 7013, 9371),
    ...
    cdf!(3111, 8887, 13479),
    // Contexts 26..=40 omitted
    // qctx = 0, txs_ctx = 64x64, plane = 1 omitted
  ],
  [
    // qctx = 1, txs_ctx = 4x4, plane = 0
    ...
    // Contexts 26..=40 omitted
    // qctx = 1, txs_ctx = 64x64, plane = 1 omitted
  ],
  [
    // qctx = 2, txs_ctx = 4x4, plane = 0
    ...
    // Contexts 26..=40 omitted
    // qctx = 2, txs_ctx = 64x64, plane = 1 omitted
  ],
  [
    // qctx = 3, txs_ctx = 4x4, plane = 0
    ...
    // Contexts 26..=40 omitted
    // qctx = 3, txs_ctx = 64x64, plane = 1 omitted
  ],
];
